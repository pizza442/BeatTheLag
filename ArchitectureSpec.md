...
|createEvent()|`scheduleStartDate`,  `scheduleEndDate`, `sleepTime`, `wakeUpTime`|JSON object|creates an event with the date, start time, and end time from the json object parameter.|
