    ...
    constructor(props) {
        ...
        this.state = {
            timezone: ["UTC -12", "UTC -11", "UTC -10", "UTC -9", "UTC -8", "UTC -7", "UTC -6", "UTC -5", "UTC -4", "UTC -3", "UTC -2", "UTC -1",
                "UTC 0", "UTC 1", "UTC 2", "UTC 3", "UTC 4", "UTC 5", "UTC 6", "UTC 7", "UTC 8", "UTC 9", "UTC 10", "UTC 11"],
            numberOfHours: 2,
            currentZone: "UTC -12",
            targetZone: "UTC -12",
            bedTime: "22:00",
    ...
    render() {
        ...
        if (this.state.generated) {
            ...
            content = 
                ...
                button = <button className="btn" onClick={() => this.sendData()}>Submit</button>;
            }    
